...
def run():
	...
	picksU = picks[today][['Bet State Chosen', 'Kelly Criterion Suggestion', 'Payouts (per Dollar)', 'League', 'Date', 'Success', 'Allocation Dollars','Allocation Percentage']]
	picksU.to_csv('./masterUpcoming.csv')
	...
	picksP = picksP[todayP][['Bet State Chosen', 'Kelly Criterion Suggestion', 'Allocation Percentage', 'League', 'Payouts (per Dollar)', 'Date', 'American Odds', 'Update Time (EST)']]
	picksP.to_csv('./masterPush.csv')
